      ...
      >
        <div className="container mx-auto px-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-6">
            ...
            <Link href="/salescoach" className="flex items-center text-gray-600 hover:text-blue-600 transition-colors text-sm">
              <Image
              ...
              <div className="overflow-hidden border-0 shadow-lg transition-all duration-300 hover:shadow-xl rounded-lg">
                ...
                <div className="p-6">
                  <p className="text-gray-600 mb-4 text-justify">
                    ...
                    transformation effort with proactive upskilling? It's not always easy to find the right
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-600 mb-6">
              ...
              <br />
              <span className="text-blue-600">Created from Expertise</span> 
              <br />
              ...
              <div className="container mx-auto px-4">
                <div className="max-w-4xl mx-auto text-center">
                  ...
                  <p className="text-xl font-medium text-white mb-2">
                    Supporting you in creating the remarkable sales organization you deserve.
                  </p>
                  <p className="text-xl font-medium text-white">For better workplaces and happier people.</p>
                  <p className="text-xl font-medium text-white">End-to-end, headache-free.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="flex flex-col items-start">
              ...
              />
              <p className="text-sm text-gray-600">Creating remarkable sales organizations</p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link href="/impressum" className="text-gray-600 hover:text-blue-600 transition-colors">
                    Impressum
                  </Link>
                </li>
                <li>
